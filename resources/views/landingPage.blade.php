...
<body id="landingPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    {{-- Hero Section --}}
    <section class="herosection container-fluid" id="index">
        <div class="col-sm-12">
            <h1 class="title" style="color: #303030">Clube de Formação de Atiradores</h1>
            <h4 class="subtitle-v1" style="color: #616161">Descubra a Precisão.<br>Sinta a Emoção.<br>Junte-se à Elite do Tiro!</h4>
    ...
    <footer>
        <section id="contact" class="row footer-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h4 style="color: white">Nossas informações de contato</h4>
